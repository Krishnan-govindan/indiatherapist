  ...
  return (
    <header className="sticky top-0 z-50 bg-[#F8F5FF]/95 backdrop-blur-sm border-b border-[#7B5FB8]/10">
      ...
      <a
        ...
        className="fixed bottom-6 right-6 z-50 flex h-14 w-14 items-center justify-center rounded-full bg-[#25D366] shadow-lg hover:bg-[#1ebe5d] transition-all hover:scale-110"
      >
